...
{
    internal class RandomToleranceGenerator : IGenerator
    {
        public void Generate(Settings settings)
        {
            ...
            var errorsIdList = $"errorsIdListToleranceS{size}.txt";
            ...
            for (int num = 0; num < filesNumber; num++)
            {
                ...
                var generatedPath = ($"StringJsonTolerance/generated-outputTolerance{num}.json");
                var generatedDoublesPath = ($"DoublesJsonTolerance/generated-outputDoublesTolerance-{num}.json");
                ...
                SchemeDouble balanceDoubleInput = new SchemeDouble
                {
                    ...
                    Label = flowNum // Math.Round(3.0 + (flowNum + 1.0) / 100.0, 2),
                };
