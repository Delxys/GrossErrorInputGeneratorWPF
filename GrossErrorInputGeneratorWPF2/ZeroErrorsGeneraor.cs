...
{
    class ZeroErrorsGeneraor:IGenerator
    {
        public void Generate(Settings settings)
        {
            ...
            //var errorsIdList = $"errorsIdListS{size}.txt";
            ...
            for (int num = 0; num < filesNumber; num++)
            {
                ...
                var generatedPath = ($"StringJsonZeroErrorsSize{size}/generated-output-ZeroErrorsS{size}-{num}.json");
                var generatedDoublesPath = ($"DoublesJsonZeroErrorsSize{size}/generated-outputDoubles-ZeroErrorsS{size}-{num}.json");
